...
[iI][nN][tT]  { return new Token(Token.INT, yytext(), yyline+1);}
[rR][eE][aA][lL]  { return new Token(Token.REAL, yytext(), yyline+1);}
[bB][oO][oO][lL]  { return new Token(Token.BOOL, yytext(), yyline+1);}
[cC][lL][aA][sS][sS] { return new Token(Token.CLASS, yytext(), yyline+1);}
[nN][eE][wW] { return new Token(Token.NEW, yytext(), yyline+1);}
[nN][iI][lL]  { return new Token(Token.NIL, yytext(), yyline+1);}

[a-zA-Z_][a-zA-Z0-9_]*  { return new Token(Token.ID, yytext(), yyline+1); }

"<:"       { return new Token(Token.SUBT, yytext(), yyline+1); }
